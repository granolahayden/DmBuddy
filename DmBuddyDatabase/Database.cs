...
public partial class Database : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LoginId).HasName("PK__LoginTer__4DDA2818A7CE27A4");
            ...
            entity.HasOne(d => d.Login).WithOne(p => p.LoginTerminations)
                .HasForeignKey<LoginTerminations>(d => d.LoginId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__LoginTerm__Login__1BC821DD");

            entity.HasOne(d => d.Role).WithMany(p => p.LoginTerminations)
